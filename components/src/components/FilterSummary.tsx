...
export const FilterSummary = (props: FilterSummaryProps) => {
    ...
    return (
        <div className="row filterbar">
            ...
            <div className="col-sm-4">
                <AssayFilterIndicatorList filters={props.filters.Data} title="Assay Data" indicateNoFilters={true} />
            </div>
        </div>
    );
};

export const AssayFilterIndicatorList: React.FC<AssayFilterIndicatorListProps> = ({
    filters,
    title,
    indicateNoFilters,
}) => {
...
export const FilterIndicatorList: React.FC<FilterIndicatorListProps> = ({
    filterClass,
    filters,
    title,
    indicateNoFilters,
