...
describe("<InnerDropdownButtons />", () => {
    ...
    test("Render", () => {
        const tree = renderer
            .create(<dropdowns.InnerDropdownButtons title={"test"} buttonData={buttonData} />)
            .toJSON();
...
describe("<OuterDropdownButtons />", () => {
    test("Render", () => {
        const tree = renderer
            .create(
                <dropdowns.OuterDropdownButton title={"Test"}>
                    <div id="test-div" />
                </dropdowns.OuterDropdownButton>,
            )
            .toJSON();
        expect(tree).toMatchSnapshot();
    });
...
describe("<DropdownButtons />", () => {
    ...
    const buttonData = [
        ...
        },
        {
            ...
            buttonData: [
                ...
                {
                    label: "another nest",
                    buttonData: [{ label: "super nested egg", action: clickMock2 }],
                },
                {
                    label: "egg2",
                },
    ...
    test("actions", () => {
        ...
        nestedDropdown
            .findWhere((x) => x.text() == "Single Button")
            .find("button")
            .simulate("click");
        ...
        nestedDropdown
            .findWhere((x) => x.text() == "super nested egg")
            .find("button")
            .simulate("click");
